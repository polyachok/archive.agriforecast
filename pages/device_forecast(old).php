...
if ($show_soil_tab) {
    ...
    $now = new DateTime();
    $overviewStartDate = $now->sub(new DateInterval('P30D'))->format('Y-m-d H:i:s');
    $detailedStartDate = (new DateTime())->sub(new DateInterval('P7D'))->format('Y-m-d H:i:s');
    ...
    <div class="column col-9 col-xs-12">
        ...
        <div class="tab-container">
            <div class="tab-controls">
                ...
                <button class="tab-btn <?= $show_forecast_tab && !$show_soil_tab ? 'active' : '' ?>"
                    data-tab="forecast">Прогноз</button>
                <?php endif; ?>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function getChartOptions(isDetailed, activeParams) {
                ...
                overviewStart.setDate(now.getDate() - 30);

                const detailedStart = new Date();
                detailedStart.setDate(now.getDate() - 7);
                ...
                return {
                    ...
                    scales: {
                        ...
                        x: {
                            ...
                            min: isDetailed ? detailedStart : overviewStart,
                            max: now,
                            title: {
                                display: true,
                                text: 'Время'
                    ...
                    plugins: {
                        ...
                        annotation: {
                            annotations: {
                                zone1: {
                                    type: 'box',
                                    xMin: isDetailed ? detailedStart : overviewStart,
                                    xMax: now,
                                    yMin: 0,
                                    yMax: zone1End,
